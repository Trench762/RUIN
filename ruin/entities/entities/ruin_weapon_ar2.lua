...
ENT.PrintName = "Ruin Weapon AR2"
ENT.Author = "Trench"
ENT.Purpose = "A stand in weapon entity for the AR2, only to be used in Ruin"
ENT.Spawnable = false 
ENT.Category = "Other"
ENT.magMax = 30 -- Used for setting initialize ammo and weapon halo rendering in sh_weapon_system.lua
...
function ENT:getRealClassName()
    return self:GetNWString('realClassName', "weapon_ar2")
end
...
function ENT:getPickUpSoundIndex()
    return self:GetNWInt('pickUpSoundIndex', 3)
end
...
if SERVER then
    ...
    function ENT:Initialize()
        self:SetModel( "models/ruin/weapons/sxv-3.mdl" )
        ...
        self:setRealClassName("weapon_ar2")
        self:setPickUpSoundIndex(3)
