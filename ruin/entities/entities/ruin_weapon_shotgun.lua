...
ENT.PrintName = "Ruin Weapon Shotgun"
ENT.Author = "Trench"
ENT.Purpose = "A stand in weapon entity for the Shotgun, only to be used in Ruin"
ENT.Spawnable = false
ENT.Category = "Other"
ENT.magMax = 3 -- Used for setting initialize ammo and weapon halo rendering in sh_weapon_system.lua
...
function ENT:getRealClassName()
    return self:GetNWString('realClassName', "weapon_shotgun")
end
...
function ENT:getPickUpSoundIndex()
    return self:GetNWInt('pickUpSoundIndex', 2)
end
...
if SERVER then
    ...
    function ENT:Initialize()
        self:SetModel( "models/ruin/weapons/gr-50.mdl" )
        ...
        self:setRealClassName("weapon_shotgun")
        self:setPickUpSoundIndex(2)
